...
core/script_gen.py  –  plotviz

Pure (Qt-free) generation of standalone matplotlib scripts from a settings /
series_meta dict. This module must never import PyQt6 or anything under ui/ so
it can be unit-tested without a Qt installation or a display.

Public entry points: generate_plot_script, _build_readme, _build_pyproject_toml.
"""
...
# returns a list of code-line strings that go inside the axes setup block.
