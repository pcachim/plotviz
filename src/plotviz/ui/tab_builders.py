...
class TabBuildersMixin:
    ...
    def create_style_tab(self):
        ...
        self.title_x.setRange(0.0, 1.0)
        self.title_x.setSingleStep(0.01)
        self.title_x.setDecimals(2)
        self.title_x.setValue(0.5)
        ...
        self.title_y.setRange(0.50, 1.00)
        self.title_y.setSingleStep(0.01)
        self.title_y.setDecimals(2)
        self.title_y.setValue(0.97)
        ...
        wl1 = QHBoxLayout()
        wl1.setSpacing(3)
        wl1.addWidget(QLabel('W:'))
        self.grid_linewidth = QDoubleSpinBox()
        self.grid_linewidth.setRange(0.1,4.0)
        self.grid_linewidth.setValue(0.5)
        self.grid_linewidth.setSingleStep(0.1)
        self.grid_linewidth.valueChanged.connect(self.update_preview)
        wl1.addWidget(self.grid_linewidth)
        maj_lay.addLayout(wl1)
        # alpha
        al1 = QHBoxLayout()
        al1.setSpacing(3)
        al1.addWidget(QLabel('α:'))
        ...
        al1.addWidget(self.grid_alpha)
        maj_lay.addLayout(al1)
        ...
        sg_btn = QPushButton('…')
        sg_btn.setFixedWidth(28)
        sg_btn.clicked.connect(lambda: self._pick_grid_color('minor'))
        c2.addWidget(self.minor_grid_color_sw)
        c2.addWidget(sg_btn)
        c2.addStretch()
        ...
        wl2 = QHBoxLayout()
        wl2.setSpacing(3)
        wl2.addWidget(QLabel('W:'))
        self.minor_grid_linewidth = QDoubleSpinBox()
        self.minor_grid_linewidth.setRange(0.1,4.0)
        self.minor_grid_linewidth.setValue(0.3)
        self.minor_grid_linewidth.setSingleStep(0.1)
        self.minor_grid_linewidth.valueChanged.connect(self.update_preview)
        wl2.addWidget(self.minor_grid_linewidth)
        min_lay.addLayout(wl2)
        # alpha
        al2 = QHBoxLayout()
        al2.setSpacing(3)
        al2.addWidget(QLabel('α:'))
        self.minor_grid_alpha = QDoubleSpinBox()
        self.minor_grid_alpha.setRange(0.0,1.0)
        self.minor_grid_alpha.setValue(0.2)
        self.minor_grid_alpha.setSingleStep(0.05)
        self.minor_grid_alpha.valueChanged.connect(self.update_preview)
        al2.addWidget(self.minor_grid_alpha)
        min_lay.addLayout(al2)
